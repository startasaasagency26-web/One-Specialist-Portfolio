...
export function SiteFooter() {
  return (
    <footer className="bg-background border-t border-white/5 py-24 pb-40">
      <div className="container-shell grid gap-20 md:grid-cols-12">
        <div className="md:col-span-5">
          ...
          <div className="mt-10 flex gap-4">
            {[MessageCircle, Phone, MapPin].map((Icon, i) => (
              <a key={i} href="#" className="flex h-10 w-10 items-center justify-center rounded-full bg-white/5 text-muted transition hover:text-brand-orange hover:bg-white/10">
                <Icon size={18} />
              </a>
            ))}
          </div>
        ...
        <div className="md:col-span-3">
          ...
          <nav className="mt-10 flex flex-col gap-5 text-sm font-bold text-muted">
            ...
            <Link href="#" className="transition hover:text-white">Service Warranty</Link>
          </nav>
        </div>
      </div>
      
      <div className="container-shell mt-24 border-t border-white/5 pt-10">
