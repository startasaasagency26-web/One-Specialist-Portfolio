...
const icons = [Wrench, Smartphone, RefreshCw];
            ...
            return (
              <Reveal key={service.title} delay={0.1 * index}>
                <motion.article
                  ...
                  className="group relative flex flex-col items-center text-center overflow-hidden rounded-[2.5rem] bg-surface p-10 ring-1 ring-line transition-all duration-500 hover:shadow-[0_32px_64px_-16px_rgba(0,0,0,0.06)] hover:ring-brand-orange/30"
                >
