  ...
  return (
    <section id="about" className="container-shell py-24 md:py-32">
      ...
      <div className="mt-12 grid gap-4 lg:grid-cols-[1.1fr_0.9fr]">
        <Reveal className="rounded-[2rem] border border-black/8 bg-white/94 p-8 shadow-[0_24px_70px_-34px_rgba(0,0,0,0.12)] backdrop-blur-xl md:p-10">
        ...
        <div className="grid gap-4">
          {aboutPrinciples.map((item, index) => (
            <Reveal
              key={item.title}
              delay={0.08 * (index + 1)}
              className="rounded-[1.75rem] border border-black/8 bg-white/92 p-5 shadow-[0_20px_60px_-34px_rgba(0,0,0,0.1)] backdrop-blur-xl"
            >
